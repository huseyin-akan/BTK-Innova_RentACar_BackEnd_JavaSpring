...
public interface InvoiceDao extends JpaRepository<Invoice, Integer>{
	...
	@Query(value="select c.first_name as firstName, c.last_name as lastName, u.email as email, r.rent_date as rentDate, r.return_date as returnDate, \r\n"
			+ "r.rented_kilometer as rentedKilometer, ca.daily_price as dailyPrice, ca.model_year as modelYear, b.name as brandName, m.model_name as modelName, ca.image_url as imageUrl, co.name as color,\r\n"
			...
			+ "left join models m on m.id = ca.model_id\r\n"
